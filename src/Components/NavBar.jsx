  ...
  return (
    <div className='bg-peach'>
      <div className='h-24 flex'>
        <div className='mr-80 pt-4 pl-20'>Logo</div>
        <div className='absolute top-10 right-96 flex'>
          {navBarItems.map((item, index) => {
            return (
              <div className='font-DM text-lg font-normal mx-2' key={index}>
        ...
        <div className='absolute right-5 top-10 flex'>
          <div className='mx-2'>Search Icon</div>
          <div className='mx-2'>Donate Button</div>
        </div>
      </div>
      <div>
